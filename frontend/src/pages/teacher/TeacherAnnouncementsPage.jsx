...
const TeacherAnnouncementsPage = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      <div>
        <h1 style={{ fontSize: '1.75rem', fontWeight: 800 }}>Institutional Notices</h1>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
          Official campus broadcasts, academic notices, and exam schedules.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <EmptyState title="No Notices Found" message="No campus announcements published." />
      ) : (
